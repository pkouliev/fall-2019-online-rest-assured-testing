...
public class ExchangeRatesAPITests {
     ...
     * http://www.google.com/index.html?q=apple&zip=12323
     * q - query parameter
     * zip - another query parameter
     * with rest assured, we provide query parameters into given() part.
     * given() - request preparation
     * you can specify query parameters in URL explicitly: https://api.exchangeratesapi.io/latest?base=USD
    ...
    public void getLatestRates() {
        ...
        // this line return today's date in the required format: yyyy-MM-dd
    ...
    public void getHistoryOfRates() {
        ...
        response.then().assertThat().
                statusCode(200).
                and(). // and() doesn't have a functional role, it's just a syntax sugar, we can chain validations
