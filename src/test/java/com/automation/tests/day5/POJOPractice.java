...
public class POJOPractice {
    ...
    public void getUser() {
        Response response = given().
                ...
                basic("admin", "admin").
                when().
                get("/spartans/{id}", 207).prettyPeek();
        ...
        assertEquals(207, spartan.getId());
        assertEquals("Nursultan", spartan.getName());
    ...
    @Test
    public void addUser() {
        Spartan spartan = new Spartan("Kirk Douglas", "Male", 1234567890L);
